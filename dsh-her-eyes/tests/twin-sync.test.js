...
test('v1.8: syncTwins registers ONE twin (route auto-vision) for the default first source provider', async () => {
  ...
  // v1.7 registered both alpha-her-eyes AND beta-her-eyes; v1.8 registers ONE 'auto-vision'.
...
test('syncTwins excludes -her-eyes and -vision routes from the default pick', async () => {
  await resetTwins()
  const ctx = makeFakeCtx(['gamma', 'gamma-vision', 'gamma-her-eyes'])
  await syncTwins(ctx, {}, true)
