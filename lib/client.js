...
".omni-settings-section-title { font-size: 13px; font-weight: 600; opacity: 0.8; }",
  ...
  "}"
	...
	var I_TOAST_ERROR = ["M8 2a6 6 0 100 12A6 6 0 008 2zm3 3L5 11M11 5L5 11"];
		...
		var modelOpts = (activeMp.checkpoint && activeMp.unet) ? igModelList[0].concat(igUnetList[0])
			: activeMp.unet ? igUnetList[0]
			: igModelList[0];
		var showVaeDd = igVaeList[0].length > 0 && !!activeMp.vae;
		var showClipDd = igClipList[0].length > 0 && !!activeMp.clip;
				...
				React.createElement("div", { className: "omni-row" }, [
					React.createElement("div", { className: "omni-field omni-grow" }, [
						...
						React.createElement("div", { className: "omni-model-wrap" }, [
							...
							modelOpts.length > 0 ? React.createElement("button", {
								className: "omni-eye-btn", type: "button",
								title: t("ddHint"),
								onClick: function (e) { e.preventDefault(); props.onToggleDd(); }
							}, React.createElement(SvgIcon, { d: isDdOpen ? I_COLLAPSE : I_EXPAND })) : null,
							isDdOpen && modelOpts.length > 0 ? React.createElement("div", { className: "omni-model-dropdown", ref: ddRef },
				...
				React.createElement("div", { className: "omni-field omni-grow" }, [
					...
					React.createElement("div", { className: "omni-model-wrap" }, [
						...
						showVaeDd ? React.createElement("button", {
							className: "omni-eye-btn", type: "button",
							title: t("ddHint"),
							onClick: function (e) { e.preventDefault(); igVaeDd[1](!igVaeDd[0]); }
						}, React.createElement(SvgIcon, { d: igVaeDd[0] ? I_COLLAPSE : I_EXPAND })) : null,
						igVaeDd[0] && showVaeDd ? React.createElement("div", { className: "omni-model-dropdown" },
							igVaeList[0].map(function (m) {
								return React.createElement("div", {
									key: m, className: "omni-dd-item" + (m === cfg.vae ? " active" : ""),
									onClick: function () { pickIgVae(m); }
								}, m);
							})) : null
					])
				]),
				React.createElement("div", { className: "omni-field omni-grow" }, [
					...
					React.createElement("div", { className: "omni-model-wrap" }, [
						...
						showClipDd ? React.createElement("button", {
							className: "omni-eye-btn", type: "button",
							title: t("ddHint"),
							onClick: function (e) { e.preventDefault(); igClipDd[1](!igClipDd[0]); }
						}, React.createElement(SvgIcon, { d: igClipDd[0] ? I_COLLAPSE : I_EXPAND })) : null,
						igClipDd[0] && showClipDd ? React.createElement("div", { className: "omni-model-dropdown" },
							igClipList[0].map(function (m) {
								return React.createElement("div", {
									key: m, className: "omni-dd-item" + (m === cfg.clip ? " active" : ""),
									onClick: function () { pickIgClip(m); }
								}, m);
							})) : null
					])
				])
