			...
			var head = React.createElement("div", { className: "omni-card-head omni-head-clickable", onClick: toggleCollapse }, [
				...
				React.createElement("div", { className: "omni-card-menu-wrap" }, [
					...
					menuOpen ? React.createElement("div", { className: "omni-card-menu", ref: menuDdRef }, [
						React.createElement("div", { className: "omni-menu-item", onClick: function () { props.onMoveTop(id); props.onCloseMenu(); } },
							React.createElement(SvgIcon, { d: I_PIN_TOP }), React.createElement("span", null, t("menuPinTop"))),
						React.createElement("div", { className: "omni-menu-item", onClick: function () { props.onMoveBottom(id); props.onCloseMenu(); } },
							React.createElement(SvgIcon, { d: I_PIN_BOTTOM }), React.createElement("span", null, t("menuPinBottom"))),
						React.createElement("div", { className: "omni-menu-item omni-menu-danger" + (confirmDel ? " omni-menu-confirm" : ""), onClick: function () { props.onDeleteClick(id); } },
		...
		var igPresetNameDraft = React.useState("");
			...
			React.useEffect(function () {
				...
				function close(e) {
					...
					if (!tgt.closest(".omni-model-wrap")) { openDd[1](null); igOpenDd[1](false); fbOpenDd[1](false); mirrorOpenDd[1](null); }
					if (!tgt.closest(".omni-provider-wrap")) { openProv[1](null); igOpenProv[1](false); }
