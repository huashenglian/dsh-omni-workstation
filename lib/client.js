...
".omni-settings-section-title { font-size: 13px; font-weight: 600; opacity: 0.8; }",
  ...
  ".omni-subtab-btn.active { background: #2a2a2e; border-color: #4a9eff; color: #fff; }",
	...
	var I_TOAST_ERROR = ["M8 2a6 6 0 100 12A6 6 0 008 2zm3 3L5 11M11 5L5 11"];
		...
		React.useEffect(function () { igSnapshot[1](JSON.stringify({ name: props.activePresetName || "", cfg: props.cfg || {} })); }, [props.activePresetId]);
		var igDirty = JSON.stringify({ name: presetNameDraft[0], cfg: props.cfg || {} }) !== igSnapshot[0];
	...
	React.createElement("button", {
		...
		title: t("presetSaved"),
		disabled: !igDirty,
		onClick: function () { props.onSavePreset(); igSnapshot[1](JSON.stringify({ name: presetNameDraft[0], cfg: props.cfg || {} })); }
...
return React.createElement("div", { className: "omni-imggen-panel" }, [head, presetBar, React.createElement("div", { className: "omni-preset-divider" }), body, confirmModal]
	...
	function AddVideoCardModal(props) {
		...
		var isCardEnabled = card.enabled !== false;
			...
			React.createElement("div", { className: "omni-card-name" }, [
				...
				React.createElement("label", { className: "omni-switch omni-switch-sm omni-card-enable", title: isCardEnabled ? "已启用" : "已禁用", onClick: function (e) { e.stopPropagation(); } }, [
					React.createElement("input", { type: "checkbox", checked: isCardEnabled, onChange: function () { props.onPatch(card.id, "enabled", !isCardEnabled); } }),
					React.createElement("span", { className: "omni-switch-slider" })
				]),
				React.createElement("button", { className: "omni-icon-btn", title: cardCollapsed ? "Expand" : "Collapse", onClick: function (e) { e.stopPropagation(); props.onPatch(card.id, "collapsed", !cardCollapsed); } }, React.createElement(SvgIcon, { d: cardCollapsed ? I_EXPAND : I_COLLAPSE }))
			]);
		...
		React.createElement("button", {
			...
			title: t("presetSaved"),
			disabled: !vcDirty,
			onClick: function () { props.onSavePreset(); vcSnapshot[1](JSON.stringify({ name: presetNameDraft[0], provider: cfg.provider || "" })); }
	}, React.createElement(SvgFillIcon, { d: I_SAVE_FLOPPY })),
			React.createElement("button", {
				className: "omni-btn omni-preset-new-btn", type: "button",
				title: t("presetNew"),
		...
		React.createElement("button", {
			...
			title: t("presetSaved"),
			disabled: !vcDirty,
			onClick: function () { props.onSavePreset(activeSubtab[0]); vcSnap[1](JSON.stringify({ name: presetNameDraft[0], cfg: cfg })); }
		}, React.createElement(SvgFillIcon, { d: I_SAVE_FLOPPY })),
					React.createElement("button", {
						className: "omni-btn omni-preset-new-btn", type: "button",
						title: t("presetNew"),
