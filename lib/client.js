...
return React.createElement("div", { className: "omni-imggen-panel" }, [head, presetBar, React.createElement("div", { className: "omni-preset-divider" }), body, confirmModal]);
	...
	function HelpModal(props) {
		...
		var igPresetNameDraft = React.useState("");
			...
			React.useEffect(function () {
				if (!menuOpen[0] && !openDd[0] && !batchOpen[0] && !openProv[0] && !igOpenDd[0] && !igOpenProv[0] && !igConfirmReset[0] && !fbOpenDd[0] && !mirrorOpenDd[0] && !videoOpenDd[0] && !videoOpenProv[0]) return;
				function close(e) {
					var tgt = e.target;
					if (!tgt || !tgt.closest) { menuOpen[1](null); openDd[1](null); batchOpen[1](false); openProv[1](null); igOpenDd[1](false); igOpenProv[1](false); igConfirmReset[1](false); fbOpenDd[1](false); mirrorOpenDd[1](null); videoOpenDd[1](false); videoOpenProv[1](false); confirmDel[1](null); confirmDelAll[1](false); return; }
					if (!tgt.closest(".omni-card-menu-wrap")) { menuOpen[1](null); confirmDel[1](null); igConfirmReset[1](false); }
					if (!tgt.closest(".omni-model-wrap")) { openDd[1](null); igOpenDd[1](false); fbOpenDd[1](false); mirrorOpenDd[1](null); videoOpenDd[1](false); }
					if (!tgt.closest(".omni-provider-wrap")) { openProv[1](null); igOpenProv[1](false); videoOpenProv[1](false); }
					if (!tgt.closest(".omni-batch-wrap")) { batchOpen[1](false); confirmDelAll[1](false); }
				}
				document.addEventListener("click", close);
				return function () { document.removeEventListener("click", close); };
			}, [menuOpen[0], openDd[0], batchOpen[0], openProv[0], igOpenDd[0], igOpenProv[0], igConfirmReset[0], fbOpenDd[0], mirrorOpenDd[0], videoOpenDd[0], videoOpenProv[0]]);
