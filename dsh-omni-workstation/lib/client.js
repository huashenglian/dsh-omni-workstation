					...
					React.createElement("div", { className: "omni-list" }, [
						...
						videoCards.map(function (card, index) {
							...
							return React.createElement(VideoPanel, {
								...
								onPatch: patchVideoCard,
								onSaveKey: saveVideoCardKey,
								onToggleReveal: toggleVideoCardReveal,
								onFetchModels: fetchVideoCardModels,
								onPickModel: pickVideoCardModel,
								onToggleDd: toggleVideoCardDd,
