...
ddHint: "Pick a model",
			...
			tabVideo: "Video",
				...
				voiceSamplePath: "Reference Audio Path",
...
return React.createElement("div", { className: "omni-imggen-panel" }, [head, presetBar, React.createElement("div", { className: "omni-preset-divider" }), body, confirmModal]);
		...
		function VideoPanel(props) {
			...
			function VoicePanel(props) {
				...
				return React.createElement("div", { className: "omni-imggen-panel omni-voice-panel" }, [
					head, presetBar, React.createElement("div", { className: "omni-preset-divider" }),
					subtabRow,
	...
	function HelpModal(props) {
		...
		var igPresetNameDraft = React.useState("");
			...
			React.useEffect(function () {
				if (!menuOpen[0] && !openDd[0] && !batchOpen[0] && !openProv[0] && !igOpenDd[0] && !igOpenProv[0] && !igConfirmReset[0] && !fbOpenDd[0] && !mirrorOpenDd[0] && !videoOpenDd[0] && !videoOpenProv[0] && !voiceOpenDd[0] && !voiceOpenProv[0] && !voicePresetDdOpen[0]) return;
				function close(e) {
					var tgt = e.target;
					if (!tgt || !tgt.closest) {
						...
						voiceOpenDd[1](false); voiceOpenProv[1](false); voicePresetDdOpen[1](false);
				...
				document.addEventListener("click", close);
				return function () { document.removeEventListener("click", close); };
			}, [menuOpen[0], openDd[0], batchOpen[0], openProv[0], igOpenDd[0], igOpenProv[0], igConfirmReset[0], fbOpenDd[0], mirrorOpenDd[0], videoOpenDd[0], videoOpenProv[0], voiceOpenDd[0], voiceOpenProv[0], voicePresetDdOpen[0]]);
		...
		function commitStructure(patch, localFn, onSuccess) {
			...
			function switchVoicePreset(id) {
				voicePresetDdOpen[1](false);
				voiceKeyDraft[1]("");
				voiceRevealed[1](false);
				voiceModelList[1]([]);
				voiceModelCount[1](null);
				commitStructure({ voicePresetSwitch: id }, null, function () { showToast('success', t('presetSwitched'), ''); });
			}
			function addVoicePreset() {
				...
				voiceModelList[1]([]);
				voiceModelCount[1](null);
				commitStructure({ voicePresetAdd: true }, null, function () { showToast('success', t('presetAdded'), ''); });
			}
			function deleteVoicePreset(id) {
				...
				voiceModelList[1]([]);
				voiceModelCount[1](null);
				commitStructure({ voicePresetDelete: id }, null, function () { showToast('success', t('presetDeleted'), ''); });
			}
			function renameVoicePreset(name) {
				queueSave({ voicePresetRename: name });
			}
